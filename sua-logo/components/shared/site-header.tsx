...
export function SiteHeader() {
  return (
    <header className="sticky top-0 z-40 border-b border-line-200 bg-white/90 backdrop-blur-md safe-area-top safe-area-left safe-area-right">
      <div className="mx-auto flex max-w-[1140px] items-center justify-between px-6 py-[15px]">
        <SiteLogo />
        <nav className="hidden items-center gap-6 text-sm font-bold text-navy-700 md:flex">
